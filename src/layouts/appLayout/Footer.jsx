...
// import logo from '../../assets/immifyLogo.jpg'
...
const Footer = () => {
    ...
    return (
        <>
            <footer className="bg-gray-800 text-white p-2 lg:p-4">
                <div className='flex flex-col w-[100%] lg:flex-row'>
                    <div className='w-[30%] lg:w-[20%] flex justify-center  py-8 '>
                        <img src={logo} alt="Logo" className='w-[50%]' />
                        {/* <p className='text-xl' >Buy Verified Travel Leads and Grow Your Business</p> */}
                    </div>
                    <div className='flex flex-col gap-8 lg:flex-row justify-around w-[60%] md:w-[80%] p-0 lg:p-2 font-semibold'>
                        <div className=' py-2 flex flex-col gap-2'>
                            <p className='cursor-pointer' onClick={() => navigate("/buy-Leads")}>Buy Travel Leads</p>
                            <p className='cursor-pointer' onClick={() => navigate("/how-it-work")}>How it works</p>
                        ...
                        <div className=' py-2 flex flex-col gap-2'>
                            <p className='cursor-pointer' onClick={() => navigate("/termsOfService")} >Terms of Service</p>
                            <p className='cursor-pointer' onClick={() => navigate("/privacyPolicy")}>Privacy Policy</p>
                            <p className='cursor-pointer' onClick={() => window.open("https://trip-z.in", "_blank")} >Traveller Website</p>
                        </div>
                    </div>

                </div>
                <p className='text-center my-4 text-sm'>2025 immify.com - All Rights Reserved</p>
            </footer>
